...
{
    public class CreateDiscoundHandler : IRequestHandler<CreateDiscoundCommand, CouponDto>
    {
        private readonly IDiscountRepository _discountRepository;
        public CreateDiscoundHandler(IDiscountRepository discountRepository)
        {
                _discountRepository = discountRepository;
        }
        public async Task<CouponDto> Handle(CreateDiscoundCommand request, CancellationToken cancellationToken)
        {
            //validate input
            ...
            //save to database
            var createdDb=await _discountRepository.CreateDiscount(coupon);
